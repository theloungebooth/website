...
const inputCls =
  "w-full border border-surface bg-surface rounded-lg md:rounded-xl px-3.5 py-2.5 md:px-4 md:py-3 text-primary placeholder:text-primary-muted focus:outline-none focus:border-primary-muted transition-all ease-linear type-base"
